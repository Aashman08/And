...
def ingest_startups():
    """Trigger startup ingestion via API."""
    print("🚀 Starting startup ingestion...")
    print(f"   API URL: {API_URL}")
    
    url = f"{API_URL}/api/ingest/startups"
    headers = {
    ...
    try:
        ...
        with httpx.Client(timeout=600.0) as client:  # 10 min timeout
            ...
            print(f"\n✅ Startup ingestion completed in {duration:.1f}s")
